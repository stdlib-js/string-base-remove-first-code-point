...
```javascript
import removeFirstCodePoint from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-remove-first-code-point@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/string-base-remove-first-code-point/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/string-base-remove-first-code-point/actions/workflows/test.yml?query=branch:v0.1.1
