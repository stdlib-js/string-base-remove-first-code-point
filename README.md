...
```javascript
removeFirstCodePoint = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-remove-first-code-point@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-base-remove-first-code-point@v0.2.0-umd/browser.js"></script>
```
